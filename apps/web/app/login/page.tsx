...
const PLATE_NODES = [
  { ref: "N-01", nm: "Zipicka", rl: "E-commerce", ang: -90 },
  { ref: "N-02", nm: "Juris Prime", rl: "UAE Licensing", ang: -18 },
  { ref: "N-03", nm: "Juris Prime Legal", rl: "Law Firm", ang: 54 },
  { ref: "N-04", nm: "SFS International", rl: "Real Estate", ang: 126 },
  { ref: "N-05", nm: "Atif Ali Production", rl: "Digital Studio", ang: 198 },
];
        ...
        <div className="feature-inner">
          ...
          <div className="feature-grid">
            <div className="feature-card">
              ...
              <p>
                Inbound messages are matched by phone number to the right Domain Agent — Zipicka,
                Juris Prime, the law firm, real estate, or the production studio.
              </p>
            </div>
            <div className="feature-card">
