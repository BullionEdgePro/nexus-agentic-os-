...
| 13 | Marketplace | 🟡 **Egress policy decided 2026-08-15: NOTHING LEAVES.** A catalogue of templates, procedures and knowledge packs a business INSTALLS. Publishing is authoring, not sharing — no tenant data flows outward, so the boundary is the absence of a path rather than a rule someone must remember. Unblocked; not built |
